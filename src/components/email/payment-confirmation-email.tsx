...
export default function PaymentConfirmationEmail({ storeName="Latidio", storeId, orderEmail="test@test.com", orderId="clvwozc58000135igexu0egeu", baseUrl="http://localhost:3000", formattedDate="18 enero 2024", name="Alan Turing", address="Garzón 1234", city="Montevideo", phone="0987654321", items=[], totalPrice=0, finalText="Texto final" }: Props) {
  ...
  <Html>
    <Head />
    <Preview>Orden de compra</Preview>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section>
          <Row>
            <Column align="center">
              <Text style={heading2}>Orden de compra</Text>
            </Column>
          </Row>
        </Section>
        <Section style={informationTable}>
          ...
          <Row style={informationTableRow}>
            <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>Cuenta</Text>
            </Column>
            <Column style={informationTableColumn}>
                <Link style={{
          ...
          <Row style={informationTableRow}>
            <Column style={informationTableColumn}>
              <Text style={informationTableLabel}>Orden</Text>
            </Column>
            <Column style={informationTableColumn}>
                <Link
                    style={{
        ...
        <Section style={productTitleTable}>
          <Text style={productsTitle}>Envío</Text>
        </Section>
        <Section>
            <Text style={envioValue}>{name}</Text>
            <Text style={envioValue}>{address}</Text>
            <Text style={envioValue}>{city}</Text>
            <Text style={envioValue}>{phone}</Text>
        </Section>
        <Section style={productTitleTable}>
