...
import { sendBankDataEmail, sendPaymentConfirmationEmail } from "@/services/email-services"
...
export async function sendTestEmailAction(storeId: string, testEmailTo: string, type: "confirmation" | "bank-data") {
