...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
          ...
          <Input className="max-w-xs" placeholder="isFeatured filter..."
              value={(table.getColumn("isFeatured")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("isFeatured")?.setFilterValue(event.target.value)}                
          />
